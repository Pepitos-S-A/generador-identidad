...
{
    internal class AgregarEmpleadoValidador : AbstractValidator<Empleado>
    {
        public AgregarEmpleadoValidador()
        {
            ...
            RuleFor(c => c.Cargo).NotEmpty().WithMessage("El cargo es requerido");
        }
    }
}
